...
public class Address {
    ...
    public static final String EXAMPLE = "123, some street, unit number, postalcode";
    public static final String MESSAGE_ADDRESS_CONSTRAINTS = "Person addresses has to be in the format block "
            + "number, street name, unit number, postalcode number.";
